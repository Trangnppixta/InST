...
class FrozenCLIPEmbedder(AbstractEncoder):
    ...
    def __init__(self, version="openai/clip-vit-large-patch14", device="cuda", max_length=77):
        local_dir = 'ldm/models/clip-vit-large-patch14'
        super().__init__()
        self.tokenizer = CLIPTokenizer.from_pretrained(local_dir)
        self.transformer = CLIPTextModel.from_pretrained(local_dir)

        self.processor = CLIPProcessor.from_pretrained(local_dir)
        self.image_encoder = CLIPModel.from_pretrained(local_dir)
